 ...
 */
export declare function deriveEscrowPDAs(buyer: PublicKey, programId?: PublicKey): Promise<DerivedPDAs>;
/**
 ...
 */
export declare function deriveEscrowAddress(buyer: PublicKey, programId?: PublicKey): [PublicKey, number];
/**
 ...
 */
export declare function deriveVaultAddress(escrow: PublicKey, programId?: PublicKey): [PublicKey, number];
/**
 ...
 */
export declare function deriveTokenVaultAddress(escrow: PublicKey, programId?: PublicKey): [PublicKey, number];
/**
 ...
 */
export declare function deriveAssociatedTokenAccount(wallet: PublicKey, mint: PublicKey, tokenProgramId?: PublicKey): PublicKey;
/**
 ...
 */
export declare function validateEscrowAddress(escrow: PublicKey, buyer: PublicKey, programId?: PublicKey): boolean;
/**
 ...
 */
export declare function validateVaultAddress(vault: PublicKey, escrow: PublicKey, programId?: PublicKey): boolean;
/**
 ...
 * @returns True if the address is valid for the given escrow
 */
export declare function validateTokenVaultAddress(tokenVault: PublicKey, escrow: PublicKey, programId?: PublicKey): boolean;
/**
 ...
 */
export declare function getPDASeedsInfo(buyer: PublicKey, programId?: PublicKey): {
    escrow: {
